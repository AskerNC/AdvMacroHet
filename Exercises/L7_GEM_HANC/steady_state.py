...
def find_ss(model,do_print=False):
    ...
    # Back out bonds level
    ss.B = (ss.tau-ss.G)/ss.r
    ss.A = ss.A_hh
    ...
    if do_print:
        ...
        print(f'Discrepancy in K+B-A_hh = {ss.K+ss.B-ss.A_hh:12.8f}') # = 0 by construction
